...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/profile/style.css" />
...
<div class="page-wrapper">
    <div class="container-fluid">
        <div class="wrapper">
            <div class="profile-card js-profile-card">
                <div class="profile-card__img">
                    <img src="https://img.icons8.com/bubbles/2x/admin-settings-male.png" alt="profile card" />
                </div>

                <div class="profile-card__cnt js-profile-cnt">
                    <div class="profile-card__name">Tharuka Mannapperuma</div>
                    <div class="profile-card-loc">
                        ...
                        <span class="profile-card-loc__txt">
                            Sri Lanka, Polgahawela
                        </span>

                    </div>
                    <br />
                    <span>Please Contact through my email for any help!</span>
                    <div class="profile-card-inf">
                        <div class="profile-card-inf__item">
                            <div class="profile-card-inf__title">Email</div>
                            <div class="profile-card-inf__txt">tharuka@mannapperuma.com</div>
                        </div>
                    </div>

                    <div class="profile-card-social">
                        <a href="https://www.facebook.com/tharukamannapperuma" class="profile-card-social__item facebook" target="_blank">
                        ...
                        <a href="https://twitter.com/tlmannapperuma" class="profile-card-social__item twitter" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
                        ...
                        <a href="https://www.instagram.com/tharukalakshan/" class="profile-card-social__item instagram" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
                        ...
                        <a href="https://github.com/TharukaMannapperuma" class="profile-card-social__item github" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
                        ...
                        <a href="https://codepen.io/tlmannapperuma" class="profile-card-social__item codepen" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
                        ...
                        <a href="http://www.mannapperuma.com" class="profile-card-social__item link" target="_blank">
                            <span class="icon-font">
                                <svg class="icon">
        ...
        <script src="<?php echo base_url(); ?>assets/profile/script.js"></script>